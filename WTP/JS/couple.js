...
document.getElementById("storyContent").innerHTML = `
    ...
    <section class="cta reveal"><p class="section-label">${copy.ctaLabel}</p><h2>${copy.ctaTitle}</h2><p>${copy.ctaText}</p><a class="cta-button" href="https://docs.google.com/forms/d/e/1FAIpQLScM19-hoWsNJ1NWmWX49GEh7Cu6SRGiVkOaPBXn4LMgafwokw/viewform?usp=header">${copy.ctaButton} &rarr;</a></section>
`;
